...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{url('/')}}/adminAssets/{{url('/')}}/adminAssets/css/animate.min.css">
    <link rel="stylesheet" type="text/css" href="{{url('/')}}/adminAssets/css/animation.css">
    <link rel="stylesheet" type="text/css" href="{{url('/')}}/adminAssets/css/bootstrap.css">
    <link rel="stylesheet" type="text/css" href="{{url('/')}}/adminAssets/css/bootstrap-select.min.css">
    <link rel="stylesheet" type="text/css" href="{{url('/')}}/adminAssets/css/style.css">
    <link rel="stylesheet" href="{{url('/')}}/adminAssets/font/fonts.css">
    <link rel="stylesheet" href="{{url('/')}}/adminAssets/icon/style.css">
    <link rel="shortcut icon" href="{{url('/')}}/adminAssets/{{url('/')}}/adminAssets/images/favicon.png">
    <link rel="apple-touch-icon-precomposed" href="{{url('/')}}/adminAssets/{{url('/')}}/adminAssets/images/favicon.png">
</head>
                ...
                <div class="section-menu-left">
                    <div class="box-logo">
                        <a href="index.html" id="site-logo-inner">
                            <img class="" id="logo_header" alt="" src="{{url('/')}}/adminAssets/images/logo/logo.png" data-light="{{url('/')}}/adminAssets/images/logo/logo.png" data-dark="{{url('/')}}/adminAssets/images/logo/logo-dark.png" >
                        </a>
                    ...
                    <div class="section-menu-left-wrap">
                        ...
                        <div class="bot text-center">
                            <div class="wrap">
                                <div class="mb-20">
                                    <img src="{{url('/')}}/adminAssets/images/menu-left/img-bot.png" alt="">
                                </div>
                                <div class="mb-20">
                    ...
                    <div class="header-dashboard">
                        <div class="wrap">
                            <div class="header-left">
                                <a href="index.html">
                                    <img class="" id="logo_header_mobile" alt="" src="{{url('/')}}/adminAssets/images/logo/logo.png" data-light="{{url('/')}}/adminAssets/images/logo/logo.png" data-dark="{{url('/')}}/adminAssets/images/logo/logo-dark.png" data-width="154px" data-height="52px" data-retina="{{url('/')}}/adminAssets/images/logo/logo@2x.png">
                                </a>
                                <div class="button-show-hide">
                                    <i class="icon-menu-left"></i>
                                </div>
                                                ...
                                                <ul>
                                                    <li class="product-item gap14 mb-10">
                                                        <div class="image no-bg">
                                                            <img src="{{url('/')}}/adminAssets/images/products/17.png" alt="">
                                                        </div>
                                                    ...
                                                    <li class="product-item gap14 mb-10">
                                                        <div class="image no-bg">
                                                            <img src="{{url('/')}}/adminAssets/images/products/18.png" alt="">
                                                        </div>
                                                        <div class="flex items-center justify-between gap20 flex-grow">
                                                            <div class="name">
                                                    ...
                                                    <li class="product-item gap14">
                                                        <div class="image no-bg">
                                                            <img src="{{url('/')}}/adminAssets/images/products/19.png" alt="">
                                                        </div>
                                                        <div class="flex items-center justify-between gap20 flex-grow">
                                                            <div class="name">
                                        ...
                                        <ul class="">
                                            ...
                                            <li>
                                                <ul>
                                                    <li class="product-item gap14 mb-10">
                                                        <div class="image no-bg">
                                                            <img src="{{url('/')}}/adminAssets/images/products/20.png" alt="">
                                                        </div>
                                                        <div class="flex items-center justify-between gap20 flex-grow">
                                                            <div class="name">
                                                    ...
                                                    <li class="product-item gap14 mb-10">
                                                        <div class="image no-bg">
                                                            <img src="{{url('/')}}/adminAssets/images/products/21.png" alt="">
                                                        </div>
                                                        <div class="flex items-center justify-between gap20 flex-grow">
                                                            <div class="name">
                                                    ...
                                                    <li class="product-item gap14 mb-10">
                                                        <div class="image no-bg">
                                                            <img src="{{url('/')}}/adminAssets/images/products/22.png" alt="">
                                                        </div>
                                                        <div class="flex items-center justify-between gap20 flex-grow">
                                                            <div class="name">
                                                    ...
                                                    <li class="product-item gap14">
                                                        <div class="image no-bg">
                                                            <img src="{{url('/')}}/adminAssets/images/products/23.png" alt="">
                                                        </div>
                                                        <div class="flex items-center justify-between gap20 flex-grow">
                                                            <div class="name">
                                                                <a href="product-list.html" class="body-text">Mega Pumpkin Bone</a>
                            ...
                            <div class="header-grid">
                                <div class="header-item country">
                                    <select class="image-select no-text">
                                        <option data-thumbnail="{{url('/')}}/adminAssets/images/country/1.png">ENG</option>
                                        <option data-thumbnail="{{url('/')}}/adminAssets/images/country/9.png">VIE</option>
                                    </select>
                                </div>
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end has-content" aria-labelledby="dropdownMenuButton1" >
                                            ...
                                            <li>
                                                <div class="noti-item w-full wg-user active">
                                                    <div class="image">
                                                        <img src="{{url('/')}}/adminAssets/images/avatar/user-11.png" alt="">
                                                    </div>
                                                    <div class="flex-grow">
                                            ...
                                            <li>
                                                <div class="noti-item w-full wg-user active">
                                                    <div class="image">
                                                        <img src="{{url('/')}}/adminAssets/images/avatar/user-12.png" alt="">
                                                    </div>
                                                    <div class="flex-grow">
                                                        <div class="flex items-center justify-between">
                                            ...
                                            <li>
                                                <div class="noti-item w-full wg-user active">
                                                    <div class="image">
                                                        <img src="{{url('/')}}/adminAssets/images/avatar/user-13.png" alt="">
                                                    </div>
                                                    <div class="flex-grow">
                                                        <div class="flex items-center justify-between">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end has-content" aria-labelledby="dropdownMenuButton4" >
                                            ...
                                            <li>
                                                <ul class="list-apps">
                                                    <li class="item">
                                                        <div class="image">
                                                            <img src="{{url('/')}}/adminAssets/images/apps/item-1.png" alt="">
                                                        </div>
                                                        <a href="#">
                                                    ...
                                                    <li class="item">
                                                        <div class="image">
                                                            <img src="{{url('/')}}/adminAssets/images/apps/item-2.png" alt="">
                                                        </div>
                                                        <a href="#">
                                                    ...
                                                    <li class="item">
                                                        <div class="image">
                                                            <img src="{{url('/')}}/adminAssets/images/apps/item-3.png" alt="">
                                                        </div>
                                                        <a href="#">
                                                    ...
                                                    <li class="item">
                                                        <div class="image">
                                                            <img src="{{url('/')}}/adminAssets/images/apps/item-4.png" alt="">
                                                        </div>
                                                        <a href="#">
                                                    ...
                                                    <li class="item">
                                                        <div class="image">
                                                            <img src="{{url('/')}}/adminAssets/images/apps/item-5.png" alt="">
                                                        </div>
                                                        <a href="#">
                                                    ...
                                                    <li class="item">
                                                        <div class="image">
                                                            <img src="{{url('/')}}/adminAssets/images/apps/item-6.png" alt="">
                                                        </div>
                                                        <a href="#">
                                                    ...
                                                    <li class="item">
                                                        <div class="image">
                                                            <img src="{{url('/')}}/adminAssets/images/apps/item-7.png" alt="">
                                                        </div>
                                                        <a href="#">
                                                    ...
                                                    <li class="item">
                                                        <div class="image">
                                                            <img src="{{url('/')}}/adminAssets/images/apps/item-8.png" alt="">
                                                        </div>
                                                        <a href="#">
                                                    ...
                                                    <li class="item">
                                                        <div class="image">
                                                            <img src="{{url('/')}}/adminAssets/images/apps/item-9.png" alt="">
                                                        </div>
                                                        <a href="#">
                                    ...
                                    <div class="dropdown">
                                        <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton3" data-bs-toggle="dropdown" aria-expanded="false">
                                            <span class="header-user wg-user">
                                                <span class="image">
                                                    <img src="{{url('/')}}/adminAssets/images/avatar/user-1.png" alt="">
                                                </span>
